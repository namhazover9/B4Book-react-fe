...
const Footer = () => {
  return (
    <footer className='bg-gray-100 p-6 sm:p-8'>
      {/* Main Container */}
      <div className='container mx-auto grid grid-cols-1 md:justify-center lg:grid-cols-2 gap-10 '>
        ...
        <div className='space-y-4 '>
          <div className='space-x-4 sm:flex sm:justify-center sm:items-center sm:text-center flex justify-center items-center text-center'>
            ...
            <span className='text-2xl sm:text-3xl font-bold text-gray-800'>Big Four</span>
          </div>
          <p className='text-gray-600 sm:flex sm:justify-center sm:items-center sm:text-center flex justify-center items-center text-center'>
        ...
        <div className='lg:flex lg:w-1/2 space-y-8 lg:space-y-0'>
          ...
          <div className='hidden lg:block lg:px-5'>
            ...
            <p className='text-gray-600 mt-2'>1418 River Drive, Suite 35</p>
          ...
          {/* Explore Links */}
          <div className='hidden lg:block lg:px-5'>
            <h3 className='text-lg font-semibold text-gray-800 underline'>Explore</h3>
            <ul className='mt-2 space-y-2 text-gray-600'>
              ...
              <li className='hover:text-gray-800 cursor-pointer'>Bookmarks</li>
              <li className='hover:text-gray-800 cursor-pointer'>Sign in/Join</li>
            </ul>
          </div>

          {/* Our Service Links */}
          <div className='hidden lg:block lg:px-5'>
            <h3 className='text-lg font-semibold text-gray-800 underline'>Service</h3>
            <ul className='mt-2 space-y-2 text-gray-600'>
              <li className='hover:text-gray-800 cursor-pointer'>Help Center</li>
              <li className='hover:text-gray-800 cursor-pointer'>Returns</li>
              <li className='hover:text-gray-800 cursor-pointer'>Product Recalls</li>
              ...
              <li className='hover:text-gray-800 cursor-pointer'>Store Pickup</li>
            </ul>
          </div>
        </div>
      </div>
      ...
      <div className='container mx-auto flex flex-col sm:flex-row md:flex-row items-center justify-between mt-8'>
        <p className='text-gray-600 text-sm text-center sm:text-left md:auto'>
