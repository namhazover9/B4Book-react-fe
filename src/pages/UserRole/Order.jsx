...
import { Radio, Button, Modal, notification, Input, Space } from 'antd';
                            ...
                            <div className="flex flex-wrap w-full ">
                                ...
                                <div className="w-full md:w-1/3 pl-0 sm:pl-10 sm:pt-5 lg:border-l sm:border-gray-300">
                                    ...
                                    <div className="flex-1 text-left space-y-2 mt-6 border-t sm:border-gray-300">
                                        ...
                                        <p className="text-md sm:text-lg font-bold m-0 ">
                                            <span className="underline">Total Amount:</span> {calculateTotalAmount()}$
                                        </p>
                                    </div>
