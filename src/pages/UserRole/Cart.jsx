...
const Cart = ({ onTotalPriceChange, onCartItemsChange, showUI }) => {
  ...
  const columns = [
    ...
    },
    {
      ...
      dataIndex: 'title',
      key: 'title',
      className: 'min-w-[120px] lg:w-[15em] bg-[#EEE5DA]',
    },
    {
      title: 'Price',
      dataIndex: 'price',
      key: 'price',
      render: (price) => `$${price}`,
      className: 'min-w-[80px] w-[10em] bg-[#EEE5DA]',
    },
    {
      title: 'Quantity',
      dataIndex: 'quantity',
      key: 'quantity',
      className: 'w-[7em] bg-[#EEE5DA]',
      render: (_, record) => (
        <InputNumber
          min={1}
...

    {
      ...
      className: 'min-w-[80px] bg-[#EEE5DA]',
    },
    {
      title: 'Actions',
      key: 'actions',
  ...
  if (!showUI)
    return (
      <div className='min-h-screen bg-[#E6DBCD] p-4 flex flex-col items-center'>
        <div className='w-full max-w-4xl bg-white p-4 shadow-md rounded-xl'>
          ...
          {cartItems.length > 0 && (
            <div className='flex flex-col sm:flex-row justify-between items-center  gap-4 mt-4'>
              <h2 className='text-md font-bold bg-[#E6DBCD] p-2 px-4 text-gray-900 rounded-lg ml-5'>
                Total Price: ${totalPriceAfterDiscount.toFixed(2)}
              </h2>
              <button
                type='primary'
                className='bg-[#679089] text-white hover:opacity-90 rounded-xl w-full sm:w-auto px-4 py-2 mr-15'
