...
const book_list = [
    ...
    {
        "title": "Frankenstein",
        "description": "A story about the consequences of scientific overreach. It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like readable English.",
        "price": 9.99,
        ...
        <div>
            <div className="header my-5 bg-slate-200 p-10 flex justify-between items-center">
                ...
                <div className="w-1/12 flex justify-between items-center">
                    <a href='/#' className='m-0 underline transition duration-200 hover:text-red-500'>Home</a>
                ...
                <div className="list-books w-1/6 flex flex-col">
                    ...
                    <div className="price">
                        ...
                        >
                            ...
                            <div className='my-5'>
                                Disabled: <Switch size="small" checked={disabled} onChange={(checked) => setDisabled(checked)} />
                            </div>
                        </Card>
                    </div>
                </div>
                        ...
                        <div className="list-by-block">
                            {currentBooks.length === 0 ? (
                                <div className="not-found">
                                    <h2 className='text-center my-20'>No books found matching the selected filters.</h2>
                                </div>
                            ) : (
                                    ...
                                    {currentBooks.map((book, index) => {
                                        ...
                                        return (
                                            <div className="flex justify-between items-center" key={index}>
                                                <div id={index} className="bg-white w-full h-auto p-3 rounded-lg transition duration-500 ease-in-out hover:shadow-md mb-4">
                            ...
                            {currentBooks.length === 0 ? (
                                ...
                                <div className="flex flex-col">
                                    {currentBooks.map((book, index) => {
                                        ...
                                        return (
                                            <div className='mx-6'>
                                                <div className="flex items-center w-3/4 rounded-lg transition-all hover:shadow-md duration-500 ease-in-out" key={index}>
                                                    ...
                                                    <div id={index} className="w-3/4 ml-2 flex flex-col justify-center">
                                                        ...
                                                        <p className="text-gray-600 text-sm mb-2 mr-4 text-balance">{book.description}</p>
                                                        <p className="text-red-500 text-2xl font-bold truncate">$ {book.price}</p>
                                                    </div>
                                                </div>
