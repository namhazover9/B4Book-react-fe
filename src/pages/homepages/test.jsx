                    ...
                    <div key={index} className="flex justify-center">
                        <div className="text-center relative">
                            <div className="relative group isolate">
                                <div className="absolute inset-0 rounded-full bg-gray-200 w-48 h-48 m-auto transition-all duration-500 group-hover:bg-red-500 group-hover:-translate-y-16 translate-y-16 z-[-1]" />
                                <img
                                    src={category.img}
                                    alt={category.label}
