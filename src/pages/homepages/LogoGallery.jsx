    ...
    <div className='flex justify-center items-center my-8 mx-5'>
      <div className='flex flex-col md:flex-row sm:flex-row  gap-4 md:gap-10 sm:gap-10'>
        <div className='flex flex-col md:flex-row items-center gap-4 hover:scale-110 transition duration-300'>
          <ShoppingCartOutlined className='text-3xl rounded-full bg-red-500 p-3 hover:scale-110 transition duration-300' />
        ...
        <div className='flex flex-col md:flex-row items-center gap-4 hover:scale-110 transition duration-300'>
          <CarOutlined className='text-3xl rounded-full bg-red-500 p-3 hover:scale-110 transition duration-300' />
          <div className='text-center md:text-left'>
        ...
        <div className='flex flex-col md:flex-row items-center gap-4 hover:scale-110 transition duration-300'>
          <TagOutlined className='text-3xl rounded-full bg-red-500 p-3 hover:scale-110 transition duration-300' />
          <div className='text-center md:text-left'>
        ...
        <div className='flex flex-col md:flex-row items-center gap-4 hover:scale-110 transition duration-300'>
          <GlobalOutlined className='text-3xl rounded-full bg-red-500 p-3 hover:scale-110 transition duration-300' />
          <div className='text-center md:text-left'>
        ...
        <div className='flex flex-col md:flex-row items-center gap-4 hover:scale-110 transition duration-300'>
          <InboxOutlined className='text-3xl rounded-full bg-red-500 p-3 hover:scale-110 transition duration-300' />
          <div className='text-center md:text-left'>
