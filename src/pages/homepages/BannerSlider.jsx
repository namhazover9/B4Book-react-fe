                    ...
                    >
                        <div className="slider-left-title text-white w-full h-full sm:w-1/2 text-center flex flex-col justify-center items-center">
                            <div className="sm:w-3/4 lg:w-3/4 md:w-4/5">
                                ...
                                >
                                    <div className="relative">
                                        <img src="src/assets/images/bannerslider/revslider_vector.png" alt="" className='absolute top-7 lg:w-1/2 left-0 z-0' />
                                        <h1 className='text-2xl sm:text-3xl font-semibold z-10 rep-title-xl-tnvd'>{slide.title}</h1>
                                    </div>
                                </div>
                                <div
                        ...
                        <div className="slider-right-image items-center w-1/2 hidden sm:flex">
                            ...
                            >
                                <img src={slide.miniBg} alt="" className='mini-bg ml-10 rep-minibg-xl-tnvd rep-minibg-2xl-tnvd rep-minibg-lg-tnvd rep-minibg-md-tnvd ' />
                                <img src={slide.image} alt="" className='absolute rep-imgbook-xl-tnvd rep-imgbook-2xl-tnvd mt-10 rep-imgbook-sm-tnvd' />
                            </div>
                        </div>
                    </div>
                ))}
