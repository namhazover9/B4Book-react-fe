...
const CarouselComponent = () => {
    const categories = [
        ...
        { img: "./src/assets/images/CategorySlider/EducationalCurriculum.png", label: "Educational Curriculum" },
        { img: "./src/assets/images/CategorySlider/Fiction&Fantasy.png", label: "Fiction & Fantasy" },
        { img: "./src/assets/images/CategorySlider/Religion&Spirituality.png", label: "Religion & Spirituality" },
        { img: "./src/assets/images/CategorySlider/RomanceBook.png", label: "Romance Books" },
        { img: "./src/assets/images/CategorySlider/Literature&Fiction.png", label: "Literature & Fiction" },
        { img: "./src/assets/images/CategorySlider/Biographies&Memoirs.png", label: "Biographies & Memoirs" },
