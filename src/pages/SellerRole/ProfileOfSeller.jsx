...
export default function ProfileOfSeller() {
    ...
    return (
        <div>
                            ...
                            <div className="flex justify-center ">
                                <label className="text-5xl rounded-full relative cursor-pointer">
                                    ...
                                    <div className="w-full h-auto hover:opacity-50">
                                        ...
                                        <img src="https://res.cloudinary.com/dmyfiyug9/image/upload/v1732850370/Screenshot_2024-11-29_101701_xvpbq2.png" alt="" className="w-29 h-29 lg:w-40 lg:h-40 rounded-full" />
                                    </div>
                                </label>
                            </div>
                        </div>
                        <div className='absolute mt-15 lg:mt-20 lg:mx-auto w-11/12 p-3 min-h-96 bg-white rounded-lg'>
                            <div className="pt-15 sm:pt-20 pb-5">
                                            ...
                                            <Form className='mt-5'>
                                                ...
                                                <div className="flex flex-col lg:flex-row w-full sm:w-11/12 mx-auto justify-end">
                                                    <div className='flex lg:flex-col w-full sm:w-11/12 mx-auto lg:w-full items-baseline'>
                                                        <label className='label-input-tnvd lg:ml-7 xl:ml-9 font-bold text-[#d0a874] truncate'>Email</label>
                                                        <div className='w-5/6 flex flex-col items-start justify-center mx-auto'>
                                                            <Field name='email' as={Input} className='w-full py-2' disabled={!isDisabled} />
                                                    ...
                                                    <div className='flex lg:flex-col w-full sm:w-11/12 mx-auto lg:w-full items-baseline'>
                                                        <label className='label-input-tnvd lg:ml-7 xl:ml-9 font-bold text-[#d0a874] truncate'>Shop Name</label>
                                                        <div className='w-5/6 flex flex-col items-start justify-center mx-auto'>
                                                            <Field name='name' as={Input} className='w-full py-2' disabled={!isDisabled} />
                                                            <div className='h-8 py-1'>
                                                ...
                                                <div className="flex flex-col lg:flex-row w-full sm:w-11/12 mx-auto justify-end">
                                                    <div className='flex lg:flex-col w-full sm:w-11/12 mx-auto lg:w-full items-baseline'>
                                                        <label className='label-input-tnvd lg:ml-7 xl:ml-9 font-bold text-[#d0a874] truncate'>Address</label>
                                                        <div className='w-5/6 flex flex-col items-start justify-center mx-auto'>
                                                            <Field name='address' as={Input} className='w-full py-2' disabled={!isDisabled} />
                                                            <div className='h-8 py-1'>
                                                    ...
                                                    <div className='flex lg:flex-col w-full sm:w-11/12 mx-auto lg:w-full items-baseline'>
                                                        <label className='label-input-tnvd lg:ml-7 xl:ml-9 font-bold text-[#d0a874] truncate'>Phone Number</label>
                                                        <div className='w-5/6 flex flex-col items-start justify-center mx-auto'>
                                                            <Field name='phoneNumber' as={Input} className='w-full py-2' disabled={!isDisabled} />
                                                            <div className='h-8 py-1'>
                                                                {touched.phoneNumber && errors.phoneNumber && (
                                                                    <div className='error text-red-500 ml-1'>{errors.phoneNumber}</div>
                                                                )}
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div className="absolute z-10 right-5 top-5">
                                                    <button className="animate-bounce bg-blue-500 rounded-xl hover:bg-white border-2 border-white hover:border-blue-500" disabled={isSubmitting}>
                                ...
                                <div className="withdraw-money w-5/6 mx-auto mt-2 lg:mt-5 flex justify-end items-center">
                                    <h4 className="mr-5">wallet: <span className="text-red-500 font-semibold">1000$</span></h4>
                                    <button className="px-5 py-2 text-white bg-blue-500 rounded-xl hover:text-blue-500 hover:bg-white border-2 border-white hover:border-blue-500 duration-300 ease-in-out" onClick={showModal}>Withdraw Money</button>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <Modal title="Withdraw Money" open={isModalOpen} onOk={handleOk} onCancel={handleCancel} footer={null}>
                <Formik
                    initialValues={{
                        amount: '',
                    }}
                    ...
                    {({ isSubmitting, errors, touched }) => (
                        <Form>
                            <div className="mb-2">
                                ...
                                <div className="amount text-end my-3">Amount: <span className="text-red-500 font-semibold">1000$</span></div>
